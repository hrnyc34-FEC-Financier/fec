...
const Question = ({question, productName}) => {
  ...
  const [questionHelpful, setQuestionHelpful] = useState({helpfulness: question.question_helpfulness, helpfulStatus: false});
  ...
  return (
    <div className="question">
      ...
      <span className="right">Helpful? &nbsp;
        <span onClick={() => {if (questionHelpful.helpfulStatus === false) {
        setQuestionHelpful({helpfulness: questionHelpful.helpfulness + 1, helpfulStatus: true}); handleHelpfulQuestion(question.question_id)}}} className="yesHelpfulQ">Yes</span>
        <span>&nbsp;({questionHelpful.helpfulness})</span>
        <span className="divider">|</span>
        <span onClick={handleOpenA} className="addAnswer"> Add Answer</span>
      </span>
