    ...
    <div>
      <div className='Carousel1'>
        ...
        <button
          ...
          onClick={(e) => handleRelatedItemClick(e.target.value)}
        >
          test
        </button>
      </div>
      <div className='Carousel2'>
        Carousel #2
        <div className='RItems_container'>{yourOutfitItems}</div>
        <button
          value={currentProduct.id}
          onClick={(e) => handleYourOutfitClick(e.target.value)}
        >
          Add
        </button>
      </div>
