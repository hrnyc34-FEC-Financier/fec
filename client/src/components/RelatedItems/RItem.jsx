    ...
    <div className='ri_container'>
      ...
      <div className='relatedItems_box'>
        ...
        <div className='RP_main_container'>
          ...
          <div className='RItems_container'>{relatedItems}</div>

          <div className='centerAlignP'>
            {relatedProductCarouselList.length - carouselRenderIndex < 5 ||
            carouselRenderIndex > 5
              ? null
              : relatedItemRightArrow}
          </div>
        </div>
      </div>
      ...
      <div className='yourOutfit_box'>
        ...
        <div className='YrOutfit_main_container'>
          <div className='centerAlignP'>
            {cYourOutfitRenderIndex <= 0 ? null : yourOutfitLeftArrow}
          </div>
          ...
          <div className='YrOutfit_container'>{yourOutfitItems}</div>

          <div className='centerAlignP'>
            {yourOutfitList.length - cYourOutfitRenderIndex < 4 ||
            cYourOutfitRenderIndex > 5
              ? null
              : yourOutfitRightArrow}
          </div>
        </div>
      </div>
